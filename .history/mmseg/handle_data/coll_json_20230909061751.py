...
seen_cls = np.load(
    r'/home/lixinhao/vss/mmseg/handle_data/group_seen.npy').tolist()
val_cls = np.load(
    r'/home/lixinhao/vss/mmseg/handle_data/group_unseen.npy').tolist()
novel_cls = np.load(
    r'/home/lixinhao/vss/mmseg/handle_data/group_novel.npy').tolist()
