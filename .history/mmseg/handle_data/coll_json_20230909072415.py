...
seen_cls = np.load(r'/home/lixinhao/vss/mmseg/handle_data/group_seen.npy').tolist().sort()
val_cls = np.load(r'/home/lixinhao/vss/mmseg/handle_data/group_unseen.npy').tolist().sort()
novel_cls = np.load(r'/home/lixinhao/vss/mmseg/handle_data/group_novel.npy').tolist().sort()
