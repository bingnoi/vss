...
class CustomDataset_video2(Dataset):
    ...
    def __init__(self,
        ...
        self.train_class = ['others', 'wall', 'ceiling', 'door', 'stair', 'ladder', 'escalator', 'Playground_slide', 'handrail_or_fence', 'window', 'rail', 'goal', 'pole', 'floor', 'ground', 'grass', 'sand', 'athletic_field', 'road', 'path', 'building', 'house', 'bridge', 'tower', 'windmill', 'well_or_well_lid', 'sky', 'mountain', 'stone', 'wood', 'ice', 'snowfield', 'grandstand', 'sea', 'river', 'waterfall', 'water', 'billboard_or_Bulletin_Board', 'sculpture', 'flag', 'parasol_or_umbrella', 'cushion_or_carpet', 'tent', 'roadblock', 'bus', 'truck', 'bicycle', 'motorcycle', 'wheeled_machine', 'ship_or_boat', 'raft', 'airplane', 'tyre', 'traffic_light', 'lamp', 'person', 'cat', 'cattle', 'other_animal', 'tree', 'flower', 'other_plant', 'toy', 'ball_net', 'backboard', 'skateboard', 'bat', 'ball', 'cupboard_or_showcase_or_storage_rack', 'box', 'traveling_case_or_trolley_case', 'basket', 'bag_or_package', 'trash_can', 'plate', 'tub_or_bowl_or_pot', 'bottle_or_cup', 'barrel', 'fishbowl', 'bed', 'pillow', 'table_or_desk', 'chair_or_seat', 'bench', 'sofa', 'shelf', 'bathtub', 'commode', 'roaster', 'other_machine', 'refrigerator', 'washing_machine', 'Microwave_oven', 'fan', 'curtain', 'textiles', 'clothes', 'painting_or_poster', 'mirror', 'flower_pot_or_vase', 'clock', 'book', 'blackboard', 'screen_or_television', 'printer', 'Mobile_phone', 'keyboard', 'other_electronic_product', 'fruit', 'food', 'instrument', 'train']
        ...
        self.test_class =['others', 'pillar', 'crosswalk', 'other_construction', 'lake', 'pipeline', 'car', 'dog', 'horse', 'cage', 'gun', 'tool', 'tissue', 'computer']
    ...
    def get_classes_and_palette(self, classes=None, palette=None):
        ...
        if self.CLASSES:
            missing_classes = [c for c in set(classes) if c not in self.CLASSES]
            if not set(classes).issubset(self.CLASSES):
                raise ValueError('classes is not a subset of CLASSES.')
