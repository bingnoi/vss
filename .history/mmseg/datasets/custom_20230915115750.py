...
class CustomDataset_video2(Dataset):
    ...
    def __init__(self,
        ...
        self.test_class =['pillar', 'crosswalk', 'other_construction', 'lake', 'pipeline', 'car', 'dog', 'horse', 'cage', 'gun', 'tool', 'tissue', 'computer']
    ...
    def prepare_train_img(self, idx):
        ...
        img_dir=os.path.join(self.data_root,'data',video,'origin/')
        # ann_dir=os.path.join(self.data_root,'data',video,'mask/')
        ann_dir=os.path.join(self.data_root,'Detectron',self.mask_file,'data',video,'mask/')
        results = dict(img_info=img_info, ann_info=ann_info)
