...
class CustomDataset(Dataset):
    ...
    def evaluate(self, results, metric='mIoU', logger=None, efficient_test=False, **kwargs):
        ...
        for i in range(num_classes):
            class_table_data.append([class_names[i]] + [m[i] for m in ret_metrics_round[2:]] +
...
class CustomDataset2(Dataset):
    ...
    def __init__(self,
        ...
        # load annotations
        self.img_infos = self.load_annotations2(self.img_dir, self.img_suffix, self.ann_dir, self.seg_map_suffix,
                                                self.split)
    ...
    def prepare_train_img(self, idx):
        ...
        try:
            ...
            for ii in dilation_used:
                ...
                im_name_new = "_".join(value_i_splits[:-2] + [(str(int(value_i_splits[-2]) + ii)).rjust(6, "0")] +
                                       value_i_splits[-1:])
        ...
        results_new = dict(img_info=img_info_clips[-1],
                           ...
                           gt_semantic_seg=gt_semantic_seg_clips)
...
class CustomDataset_video2(Dataset):
    ...
    def __init__(self,
        ...
        #         self.split = osp.join(self.data_root, self.split)
        TRAIN_CLASSES = {
            'others': '0','wall': '1','ceiling': '2','door': '3','stair': '4',
            'ladder': '5',
            'escalator': '6',
            'Playground_slide': '7',
            'handrail_or_fence': '8',
            ...
            'waterfall': '35',
            'water': '36',
            'billboard_or_Bulletin_Board': '37',
            'sculpture': '38',
            'flag': '39',
            'parasol_or_umbrella': '40',
            'cushion_or_carpet': '41',
            'tent': '42',
            'roadblock': '43',
            'bus': '44',
            'truck': '45',
            ...
            'bat': '66',
            'ball': '67',
            'cupboard_or_showcase_or_storage_rack': '68',
            'box': '69',
            'traveling_case_or_trolley_case': '70',
            'basket': '71',
            'bag_or_package': '72',
            'trash_can': '73',
            'plate': '74',
            'tub_or_bowl_or_pot': '75',
            'bottle_or_cup': '76',
            'barrel': '77',
            'fishbowl': '78',
            'bed': '79',
            ...
            'textiles': '95',
            'clothes': '96',
            'painting_or_poster': '97',
            'mirror': '98',
            'flower_pot_or_vase': '99',
            'clock': '100',
            'book': '101',
            'blackboard': '102',
            'screen_or_television': '103',
            'printer': '104',
            'Mobile_phone': '105',
            'keyboard': '106',
            'other_electronic_product': '107',
            'fruit': '108',
            'food': '109',
            'instrument': '110',
            'train': '111'
    ...
    def format_results(self, results, save_path=None, **kwargs):
        ...
        for ii in range(len(results)):
            ...
            save_path_ii = os.path.join(save_path, 'result_submission', video,
                                        img_name.replace(self.img_suffix, self.seg_map_suffix))
...
class CustomDataset_video2_vps(Dataset):
    ...
    def format_results(self, results, save_path=None, **kwargs):
        ...
        for ii in range(len(results)):
            ...
            save_path_ii = os.path.join(save_path, 'result_submission', video.replace('___', '/Pred/'),
                                        img_name.replace(self.img_suffix, self.seg_map_suffix))
            save_path_directory = os.path.dirname(save_path_ii)
            if not os.path.exists(save_path_directory):
                os.makedirs(save_path_directory)
