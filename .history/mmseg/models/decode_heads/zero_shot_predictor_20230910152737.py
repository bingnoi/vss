...
class  TransformerZeroshotPredictor(nn.Module):
    ...
    def forward(self, x, mask_features, images_tensor=None, ori_sizes=None):
        ...
        if self.mask_classification:
            ...
            print("ss1",logit_scale.shape, x_cls.shape , self.text_features.clone().detach().t().shape)
            if self.training:
            ...
            print("ss2",logit_scale.shape, x_cls.shape , self.bg_feature.t().shape)
