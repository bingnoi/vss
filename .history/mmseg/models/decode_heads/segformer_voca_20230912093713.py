...
class SegFormerHead_ZeroShot(BaseDecodeHead_clips):
    ...
    def __init__(self, feature_strides, **kwargs):
        ...
        self.deco1=small_decoder2(embedding_dim,256, 512)
    ...
    def forward(self,inputs, batch_size=None, num_clips=None):
        ...
        outs[0] = self.linearconv1(supp_feats[0]) 
        ...
        output_f = torch.cat([out1,out2,out3,out4],dim=1).squeeze(0)
        
        # cat_f = torch.cat([supp_feats_f,outs_f])
        prediction = self.predictor(output_f,output_f).permute(0,3,1,2)
