...
class BaseDecodeHead(nn.Module, metaclass=ABCMeta):
    ...
    def forward_train(self, inputs, img_metas, gt_semantic_seg, train_cfg,memory):
        ...
        """
        seg_logits,memory = self.forward(inputs,memory)
...
class BaseDecodeHead_clips(nn.Module, metaclass=ABCMeta):
    ...
    def losses(self, seg_logit, seg_label):
        ...
        # print('k',seg_logit.shape, seg_label.shape)
