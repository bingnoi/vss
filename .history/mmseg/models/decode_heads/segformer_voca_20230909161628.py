...
class SegFormerHead_ZeroShot(BaseDecodeHead_clips):
    ...
    def __init__(self, feature_strides, **kwargs):
        ...
        self.linearconv1 = nn.Conv2d(256,512,kernel_size=)
    ...
    def forward(self,inputs, batch_size=None, num_clips=None):
        ...
        # supp_feats_f = torch.cat(supp_feats,dim=1)
        ...
        output=torch.cat([out1,out2,out3,out4],dim=1)   ## b*(k+k)*124*h*w
        
        prediction = self.predictor(outs_f,_c)
