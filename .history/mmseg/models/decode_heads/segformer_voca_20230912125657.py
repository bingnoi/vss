...
class SegFormerHead_ZeroShot(BaseDecodeHead_clips):
    ...
    def forward(self,inputs, batch_size=None, num_clips=None):
        ...
        out4=resize(self.deco4(supp_feats[3]), size=(h, w),mode='bilinear',align_corners=False).unsqueeze(0)
        ...
        prediction = self.predictor(output,output_f).permute(0,3,1,2).unsqueeze(0)
