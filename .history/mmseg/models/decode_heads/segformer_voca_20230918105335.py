...
class SegFormerHead_ZeroShot(BaseDecodeHead_clips):
    ...
    def __init__(self, feature_strides, **kwargs):
        ...
        self.linear_pred = nn.Conv2d(embedding_dim, 111, kernel_size=1)
    ...
    def forward(self,inputs, batch_size=None, num_clips=None):
        ...
        _c_f = resize(_c,size=(60,60),mode='bilinear',align_corners=False)
        fuse_f = torch.split(_c_f,split_size_or_sections=1,dim=0)
        ...
        print("fuse",len(fuse_f))
        
        mask_feature,transformer_encoder_feature = self.pixel_decoder(fuse_f)
        
        print("hh",mask_features.shape,transformer_encoder_features.shape)
