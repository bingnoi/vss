...
class  CatClassifier(nn.Module):
    def __init__(self,):
        ...
        clip_model, clip_preprocess = clip.load(clip_pretrained, device=device, jit=False,prompt_depth=0, prompt_length=0)
    ...
    def forward(self, ori_images,fuse_f, images_tensor=None, ori_sizes=None):
