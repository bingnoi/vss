        ...
        if pretrained:
            ...
            if checkpoint_path:
                ...
                try:
                    ...
                    logging.info(f'The checkpoint does not match, make sure you are doing mask prompt tuning.')
            else:
                error_str = (
...
def create_model_and_transforms(
    ...
    preprocess_val_entire = image_transform_v2(
        pp_cfg,
        is_train=False,
        with_mask=False
    )

    return model, preprocess_train, preprocess_val, preprocess_val_entire
