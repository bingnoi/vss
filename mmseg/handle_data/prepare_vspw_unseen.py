...
id_map = {0:0}
test_list = [3,7,11,22,38,44,53,60,79,86,99,103,116]
...
def worker(file_tuple):
    ...
    for obj_id in np.unique(lab):
        if obj_id > 80:
        # test_class = [0,3,7,11,22,38,44,53,60,79,86,99,103,116]
        # if obj_id in test_class :
    ...
    for root, dirs, files in os.walk(dataset_dir):
        for filename in files:
            ...
            if(seri in val_set and type_d == 'mask'):
                ...
                out_path = Path() / "/home/lixinhao/vss/data/test/vspw/VSPW_480p" / "Detectron" / "val_unseen" /"/".join(directory.split(os.path.sep)[-2:]) 
