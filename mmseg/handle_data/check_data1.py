data_dir = "/home/lixinhao/vss/mmseg/handle_data/Sheet1.csv"
...
with open(data_dir,"r") as csvfile:
    ...
    for row in csvreader:
        rowdata = row[8].split(";")
        data_class.extend(rowdata)
        
# print(data_class)

l = [key for key in CLASSES.keys() if key not in data_class]

print(l,len(l))

# print('building' in data_class)