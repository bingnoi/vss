...
test_class = [3,7,11,22,38,44,53,60,79,86,99,103,116]
train_class = [i for i in range(0,125) if i not in test_class]
print(train_class,len(train_class))
count = 0
...
for key, value in CLASSES.items():
    ...
    #     continue
    # elif int(value)<=111:
    #     train_class_name.append(key)
    #     train_plate_name.append(PALETTE[count])
    #     count+=1
    # elif int(value)>111:
    #     test_class_name.append(key)
    #     print(int(value),count)
    #     test_plate_name.append(PALETTE[count])
    #     count+=1
    
    if count == 0:
        count += 1
        continue
    merged_data.append({"color": PALETTE[count-1], "id": int(value), "name": key,"isthing":1})
    # if int(value) in train_class:
    if int(value) <= 111:
        train_class_name.append(key)
        train_plate_name.append(PALETTE[count-1])
        # train_map.append({"color": PALETTE[count-1], "id": int(value), "name": key, "trainid":len(train_map)+1})
    else:
        test_class_name.append(key)
        test_plate_name.append(PALETTE[count-1])
        # test_map.append({"color": PALETTE[count-1], "id": int(value), "name": key, "trainid":len(test_map)+1})
    count += 1

# print(merged_data)
print(train_class_name,train_plate_name,train_map)
print(test_class_name,test_plate_name,test_map)

# with open(r'/home/lixinhao/vss/mmseg/handle_data/seen_classnames.json',
#           'w') as f_out:
#     json.dump(train_class_name, f_out)

# with open(r'/home/lixinhao/vss/mmseg/handle_data/unseen_classnames.json',
#           'w') as f_out:
#     json.dump(test_class_name, f_out)

# with open(r'/home/lixinhao/vss/mmseg/handle_data/all_classnames.json',
#           'w') as f_out:
#     json.dump(train_class_name + test_class_name, f_out)


# novel_ = []

count = 0
# for item in merged_data[:111]:
#     dic = item
...
# print('seen', [i for i in seen_],[i for i in unseen_])
